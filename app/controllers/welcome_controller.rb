class WelcomeController < ActionController::Base
  ...
  def index
    render text: "<h1> Welcome to Rails, buy the ticket, take the ride...</h1>"
  end



  def show
    render text: "<h3> Local host 3000, sing it, #{params["name"]}! </h3>"
  end
